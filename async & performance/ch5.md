...
**Примечание:** Возможно вас интересуют вопросы микро производительности, такие как "Что исполняется быстрее: `a++` или `++a`?". Мы рассмотрим такие вопросы в следующей главе.
